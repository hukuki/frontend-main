...
const Login = () => {
  return (
    <>
      <Flex minH={"70vh"} minW={"80vw"} align={"center"} justify={"center"} bg={useColorModeValue("gray.50", "gray.800")}>
        <Stack spacing={8} mx={"auto"} width={"3xl"} py={12} px={6}>
          <Stack align={"center"}>
            <Heading fontSize={"4xl"}>Doküman Arama</Heading>
          </Stack>
          <Box rounded={"xl"} bg={useColorModeValue("white", "gray.700")} boxShadow={"lg"} p={16}>
                ...
                <AccordionPanel pb={4}>
                  <HStack>
                    ...
                    <FormControl flex={1}>
                      ...
                      <Input placeholder="" size="md" type="number" />
                    </FormControl>
                  </HStack>
                </AccordionPanel>
              </AccordionItem>
