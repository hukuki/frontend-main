    ...
    <>
      {modalOpen && (
        <div className="relative">
          <ErrorModal isOpen={modalOpen} closeModal={() => setModalOpen(false)}>
            <ErrorModal.Panel>
              <ErrorModal.Title>Payment successful</ErrorModal.Title>
              <div className="mt-2">
              ...
              <div className="mt-4">
                <ErrorModal.Button onClick={() => setModalOpen(false)}>Got it, thanks!</ErrorModal.Button>
              </div>
            </ErrorModal.Panel>
          </ErrorModal>
        </div>
      ...
      <Container className="pt-20 pb-16 text-center lg:pt-32">
        <h1 className="mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight text-slate-800 sm:text-7xl">
          <Typewriter loop cursor words={['Mevzuat', 'İçtihat', 'Literatür']} />
          <span className="text-blue-600 relative whitespace-nowrap">
            ...
            <span className="relative"> aramak </span>
          </span>
          <p>
        ...
        <p className="mx-auto mt-6 max-w-2xl text-lg tracking-tight text-slate-700">
          Son teknoloji yapay zekanın gücüyle belgelerinizi kolayca bulun
        </p>
