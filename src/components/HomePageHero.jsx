    ...
    <Container className="pt-20 pb-16 text-center lg:pt-32">
      <h1 className="mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight text-slate-900 sm:text-7xl">
        ...
        <span className="text-blue-600 relative whitespace-nowrap">
          ...
          <span className="relative"> document </span>
        </span>
        <p>
          search made <span className="text-violet-500">ease</span>
        </p>
      </h1>
      <p className="mx-auto mt-6 max-w-2xl text-lg tracking-tight text-slate-700">With the power of AI, find your documents with ease</p>
