    ...
    <Container className="pt-20 pb-16 text-center lg:pt-32">
      <h1 className="mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight text-slate-900 sm:text-7xl">
        ...
        <span className="text-blue-600 relative whitespace-nowrap">
          ...
          <span className="relative"> döküman aramak </span>
        </span>
        <p>
          hiç bu kadar <span className="text-violet-500">kolay</span> olmamıştı
        </p>
      </h1>
      <p className="mx-auto mt-6 max-w-2xl text-lg tracking-tight text-slate-700">Yapay zekanın gücüyle aradığınızı kolayca bulun</p>
      <div className="mt-10 flex justify-center space-x-6">
        ...
        <Button variant="outline" color="blue">
          ...
          <span className="ml-3">Demoyu İzle</span>
        </Button>
      </div>
      <div className="mt-36 lg:mt-44">
        <p className="flex justify-center text-base text-slate-900">Endüstrinin tercihi</p>
      </div>
    </Container>
  );
}
